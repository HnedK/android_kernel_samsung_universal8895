...
/*
 * Backport of path_umount from Linux 5.9+ for KernelSU support.
 * This provides the int path_umount(struct path *path, int flags)
 * function that KernelSU's core_hook.c uses for module umounting.
 */
#ifdef CONFIG_KSU
